...
import { Wrapper, LSidebar, Contnent, Footer, Header, Middle, RSidebar, Button, Link } from './components/Stuff';
import './App.css';
...
import { TwilightSparkle, RainbowDash, Applejack, Rarity, Fluttershy, PinkiePie, Spike } from './components/Character';
...
function picture(name) {
  return () => {
    switch (name) {
      case 'Twilight Sparkle': return <img src={TwilightS} alt="Twilight Sparkle" width={200} />;
      case 'Rainbow Dash': return <img src={RainbowD} alt="Rainbow Dash" width={200} />;
      case 'Applejack': return <img src={ApplejackI} alt="Applejack" width={200} />;
      case 'Rarity': return <img src={RarityI} alt="Rarity" width={200} />;
      case 'Fluttershy': return <img src={FluttershyI} alt="Fluttershy" width={200} />;
      case 'Pinkie Pie': return <img src={PinkieP} alt="Pinkie Pie" width={200} />;
      case 'Spike': return <img src={SpikeI} alt="Spike" width={200} />;
